            ...
            <div className='container'>
                <div className='row'>
                    {monthlyTour.map((tour, index) => (
                        <div className='col-sm-12 col-md-6' key={tour.monthly_tour_id}>
                            <div className="card" >
                    ...
                    {nextMonthlyTour.map((tour, index) => (
                        <div className='col-sm-12 col-md-6' key={tour.monthly_tour_id}>
                            <div className="card" >
                                <img src="./assets/images/principal/monthly-tour.jpeg" className="card-img-top" alt="..."></img>
                                <div className="card-body">
                                    <h5 className="card-title" style={{textTransform:'uppercase'}}>{tour.tour_destiny}</h5>
                                    <h5 className="card-title" style={{textTransform:'uppercase'}}>{tour.tour_name}</h5>
                                    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <a href="#" className="btn btn-primary">Ver más</a>
                                </div>
                            </div>
