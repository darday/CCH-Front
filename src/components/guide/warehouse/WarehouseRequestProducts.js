...
export const WarehouseRequestProducts = () => {
    ...
    const aceptarModal = async () => {
        ...
        try {
            // Seleccionar el primer elemento de data (si existe)
            const firstProduct = data[0];

            if (firstProduct) {
                const response = await axios.post(`${ApiUrl}request-product-update-status/${requestCompleteProductsId}`);

                // Verificar la respuesta del servidor
                if (response.data.success) {
                    toast.success("Solicitud generada exitosamente", { position: toast.POSITION.BOTTOM_RIGHT });
                    setrequestGenerate(true); // Marcar la solicitud como generada
                ...
                toast.error("No hay productos para generar la solicitud", { position: toast.POSITION.BOTTOM_RIGHT });
            }
        } catch (error) {
            console.error(error);
            toast.error("Error al generar la solicitud", { position: toast.POSITION.BOTTOM_RIGHT });
    ...
    const onSubmit = async (event) => {
        ...
        if (requestProductToAddSelected && requestProductToAddSelected.value) {
            ...
            formData.append("request_complete_products_id", requestCompleteProductsId);
            ...
            try {
                ...
                console.log(resp);
                console.log("Impreson de warehouseProductSelect SOY DAVID: ", warehouseProductSelect);
    ...
    const dataList = async () => {
        try {
            const response = await axios.get(ApiUrl + 'request-product-list');
    ...
    const onSubmitForm2 = async (event) => {
        ...
        if (!formD2.detail || !formD2.fecha) {
            ...
            toast.error("Por favor, completa todos los campos obligatorios", { position: toast.POSITION.BOTTOM_RIGHT });
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <form onSubmit={onSubmitForm2}>
                                ...
                                <br></br>
                                <button type="submit" className="btn btn-success" onClick={mostrarFormulario}> Guardar </button> &nbsp;
                            </form>
                        </div>

                        {/* {showForm && formD2.detail && formD2.fecha && ( */}
                        {showForm && (
                            <div className="card-body">
                                <div className='col-12 '>
                                    <div className='row'>
                                        ...
                                        <div className='col-8'>
                                            <p style={{ fontSize: '20px' }}> {listTiltle} </p>
                                        </div>
                                    </div>
                                </div>
                                <div className='col-12 '>
                                    <div className='row'>
                                        ...
                                        <div className='col-8'>
                                            <p style={{ fontSize: '20px' }}> {listDate} </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className='row'>
                                        <div className='col-12 '>
                                            <div className='row'>
                                                ...
                                                {/* <input type="hidden" name='user_id' className="form-control" value={'2'} ></input> */}
                                                <div className='col-2'>
                                                    <div className="">
                                                ...
                                                {/* <input type="hidden" name='category_id' className="form-control" value={'14'} ></input> */}
                                                <div className='col-2'>
                                                    <div className="">
            ...
            <div className="modal fade" id="watchModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            Desea generar solicitud de productos?<b></b>
                        </div>
                        <div className="modal-footer">
