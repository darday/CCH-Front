...
export const EditEquipmentRent = () => {
    ...
    const getData = async ()=>{
        await axios.get(ApiUrl+'equipment-rent-show/'+equipmentId)
        .then(resp=>{
    ...
    const onsubmit = async (event) => {
        ...
        setisLoading(true);
        await axios.post(ApiUrl + "equipment-rent-update/" + equipmentId, f)
            .then(res => {
                res = res.data;
                console.log(res);
                setisLoading(false);
